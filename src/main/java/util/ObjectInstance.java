...
public class ObjectInstance {
  ...
  public <K extends IVertexData> ObjectInstance(GL3 gl, ShaderProgram program, util.ShaderLocationsVault shaderLocations, Map<String, String> shaderVarsToAttributeNames, PolygonMesh<K> mesh, String name) {
  ...
  public <K extends IVertexData> ObjectInstance(GL3 gl, util.ShaderLocationsVault shaderLocations, Map<String, String> shaderVarsToAttributeNames, PolygonMesh<K> mesh, String name) {
   ...
   */
  protected <K extends IVertexData> void initPolygonMesh(GL3 gl, ShaderProgram program, util.ShaderLocationsVault shaderLocations, Map<String, String> shaderVarsToAttributeNames, PolygonMesh<K> mesh) {
    int i, j;
   ...
   * @param mesh                       the underlying polygon mesh
   */
  protected <K extends IVertexData> void initPolygonMesh(GL3 gl, util.ShaderLocationsVault shaderLocations, Map<String, String> shaderVarsToAttributeNames, PolygonMesh<K> mesh) {
    int i, j;
